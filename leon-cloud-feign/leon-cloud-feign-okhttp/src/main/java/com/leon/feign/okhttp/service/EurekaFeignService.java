...
import com.leon.feign.okhttp.config.FeignOkHttpConfig;
 ...
 **/
@FeignClient(value = "leon-register-eureka-client", configuration = FeignOkHttpConfig.class) // 里面配置的value 就是服务的名称
//@FeignClient(value = "leon-register-eureka-client")
